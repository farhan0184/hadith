...
import { Mosque } from '@/assets/images'
        ...
        <div className="lg:w-[20%] lg:block hidden space-y-5">
            <div className="bg-white rounded-xl p-4 space-y-5">
                ...
                <div>
                    ...
                    <input className="mt-2 w-full bg-[#2b9e76]" type="range" id="volume" name="volume" min="0" max="11"  />
                </div>
                <div>
            ...
            <div className={`p-4 space-y-5 bg-[#2b9e76]/20 rounded-xl`}> 
